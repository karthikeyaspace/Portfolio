...
export default function Navbar(props) {
    ...
    return (
        <div className="header h-16 w-full bg-primary fixed top-0 z-10 border-b-2 border-secondary">
            <nav className='container flex flex-row justify-between items-center h-full px-12 py-0 text-secondary'>
                ...
                <ul className={menu ? 'nav-menu active' : 'nav-menu'}>
                    ...
                    <div className="themes flex flex-row">
                        ...
                        <button onClick={() => props.setTheme('pink')} className="theme-button">Pink</button>
                    </div>
                </ul>
